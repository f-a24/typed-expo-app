    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.tabs}>
          <TouchableOpacity
            style={styles.tab}
            onPress={() => this.onTabPress('library', I18n.t('Take.tab1'))}
          >
            <Text
              font="noto-sans-bold"
              style={[
          ...
          <TouchableOpacity
            style={styles.tab}
            onPress={() => this.onTabPress('photo', I18n.t('Take.tab2'))}
          >
            <Text
              font="noto-sans-bold"
              style={[
          ...
          <TouchableOpacity
            style={styles.tab}
            onPress={() => this.onTabPress('movie', I18n.t('Take.tab3'))}
          >
            <Text
              font="noto-sans-bold"
              style={[
